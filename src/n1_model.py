...
class auto_encoder(object):
    def __init__(self, sess):
        ...
        self.train_data_dir = r"D:\autoimplant-master\training_set\defective_skull_p1"
        # ground truth (implants) for the training data
        self.train_label_dir = r"D:\autoimplant-master\training_set\implant_p1"
        # test data directory
        self.test_data_dir = r"D:\autoimplant-master\training_set\defective_skull_p1"
    ...
    def test(self):
        ...
        for i in range(len(pair_list)):
            ...
            #---------------
            if i < 10:
                filename=self.save_dir+r"\00%d.nrrd"%i
            elif i < 100:
                filename=self.save_dir+r"\0%d.nrrd"%i
            else:
                filename=self.save_dir+r"\%d.nrrd"%i
            #---------------
    ...
    def valid(self):
        ...
        print("accuracy:",a/len(self.valid_set))
    #-----------------------------------------
