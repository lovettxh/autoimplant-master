...
class auto_encoder(object):
    ...
    def encoder_decoder(self, inputI):
        ...
        max4 = tf.nn.max_pool3d(conv4_2, [1,2,2,2,1], [1,2,2,2,1], padding='VALID')
        conv5_1 = conv_bn_relu(input=max4, output_chn=512, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='conv5_1')
        conv5_2 = conv_bn_relu(input=conv5_1, output_chn=512, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='conv5_2')
        print('5',conv5_2.shape)

        deconv0_1 = deconv_bn_relu(input=conv5_2, output_chn=512, is_training=phase_flag, name='deconv0_1')
        deconv0_2 = tf.concat([deconv0_1, conv4_2], 4)
        deconv0_3 = conv_bn_relu(input=deconv0_2, output_chn=512, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='deconv0_3')
        deconv0_4 = conv_bn_relu(input=deconv0_3, output_chn=512, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='deconv0_4')
        print('6',deconv0_4.shape)
        deconv1_1 = deconv_bn_relu(input=deconv0_4, output_chn=512, is_training=phase_flag, name='deconv1_1')
        deconv1_2 = tf.concat([deconv1_1, conv3_2], 4)
        deconv1_3 = conv_bn_relu(input=deconv1_2, output_chn=256, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='deconv1_3')
        deconv1_4 = conv_bn_relu(input=deconv1_3, output_chn=256, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='deconv1_4')
        print('7',deconv1_4.shape)
        deconv2_1 = deconv_bn_relu(input=deconv1_4, output_chn=256, is_training=phase_flag, name='deconv2_1')
        deconv2_2 = tf.concat([deconv2_1, conv2_2], 4)
        deconv2_3 = conv_bn_relu(input=deconv2_2, output_chn=128, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='deconv2_3')
        deconv2_4 = conv_bn_relu(input=deconv2_3, output_chn=128, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='deconv2_4')
        print('8',deconv2_4.shape)
        deconv3_1 = deconv_bn_relu(input=deconv2_4, output_chn=128, is_training=phase_flag, name='deconv3_1')
        deconv3_2 = tf.concat([deconv3_1, conv1_2], 4)
        deconv3_3 = conv_bn_relu(input=deconv3_2, output_chn=64, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='deconv3_3')
        deconv3_4 = conv_bn_relu(input=deconv3_3, output_chn=32, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='deconv3_4')
        deconv3_5 = conv_bn_relu(input=deconv3_4, output_chn=32, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='deconv3_5')
        print('9',deconv3_5.shape)


        pred_prob1 = conv_bn_relu(input=deconv3_5, output_chn=self.output_chn, kernel_size=3, stride=1, use_bias=True, is_training=phase_flag, name='pred_prob1')
